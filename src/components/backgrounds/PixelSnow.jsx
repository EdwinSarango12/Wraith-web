...
const PixelSnow = ({
  ...
  }, [brightness, colorVector, density, depthFade, direction, farPlane, flakeSize, gamma, handleResize, minFlakeSize, pixelResolution, speed, variantValue])
  ...
  return (
    <div
      ref={containerRef}
      className={`absolute inset-0 h-full w-full transform-gpu will-change-transform ${className}`}
      style={style}
    />
  )
}
