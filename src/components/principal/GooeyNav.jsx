...
const GooeyNav = ({
  ...
  // Dispara la animación gooey al pasar el cursor (hover), sin marcar activo
  const handleHover = e => {
    const liEl = e.currentTarget;
    updateEffectPosition(liEl);
    if (filterRef.current) {
    ...
    <>
      ...
      <style>
        {`
          ...
          /* Pill blanco que aparece en hover/focus (texto negro encima) */
          .gooey-nav-container .effect.filter::after { display: none; }
          .gooey-nav-container li::after {
            content: "";
            position: absolute;
            inset: 0;
          ...
          .gooey-nav-container li:hover::after,
          .gooey-nav-container li:focus-within::after {
            opacity: 1;
            transform: scale(1);
          }
          .gooey-nav-container li:hover,
          .gooey-nav-container li:hover a,
          .gooey-nav-container li:focus-within,
          .gooey-nav-container li:focus-within a {
            color: #000;
          }
            ...
            {items.map((item, index) => (
              ...
              >
                <a
                  ...
                  href={item.href || '#'}
                  onFocus={e => handleHover({ currentTarget: e.currentTarget.parentElement })}
